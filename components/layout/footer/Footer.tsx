        ...
        <div className="mb-16 grid grid-cols-1 gap-8 md:grid-cols-12">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4">
              {accessLinks.map((item, i) => (
                <li
                  key={i}
                  className="flex cursor-pointer items-center gap-2 text-gray-400 transition-colors hover:text-blue-500"
                >
          ...
          */}
          ...
          <div className="md:col-span-6">
            ...
            <p className="mb-8 text-justify leading-relaxed text-gray-400">
            ...
            <div className="flex flex-wrap gap-4">
              {/* Google Play Button */}
              <button className="flex items-center gap-3 rounded-lg border border-gray-800 bg-[#1a1a1a] px-4 py-2 transition-colors hover:bg-[#2a2a2a]">
                <PlayStoreIcon />
