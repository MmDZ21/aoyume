...
export function AnimeDetailsSkeleton() {
  return (
    <div className="border-primary/20 relative w-full overflow-hidden rounded-2xl border-2 bg-muted/10">
      {/* Background Skeleton */}
      ...
      <div className="relative z-10 flex flex-col gap-8 p-6 md:p-10">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-stretch lg:justify-between">
          ...
          <div className="order-1 flex flex-col gap-6 lg:flex-row lg:items-start">
            ...
            <div className="mx-auto shrink-0 lg:mx-0">
              <Skeleton className="h-96 w-64 rounded-2xl bg-muted/20 shadow-2xl" />
            </div>

            {/* Info Section Skeleton */}
            <div className="flex w-full flex-col gap-6 text-right max-w-sm">
              <Skeleton className="mx-auto h-10 w-3/4 bg-muted/20 md:mx-0" />
              
              <Skeleton className="h-10 w-48 rounded-md bg-muted/20" />
        ...
        <div className="mt-4 border-t border-white/10 pt-6">
          <Skeleton className="mb-4 h-8 w-32 bg-muted/20" />
